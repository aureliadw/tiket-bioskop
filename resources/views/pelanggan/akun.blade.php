                ...
                <div class="lg:col-span-1">
                    <div class="bg-gradient-to-br from-neutral-900 via-neutral-900 to-neutral-950 rounded-2xl p-6 border border-neutral-800/50 shadow-2xl">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <h3 class="text-xl font-black mb-1">{{ $user->name }}</h3>
                            ...
                            <div class="w-full mt-4 pt-4 border-t border-neutral-800 grid grid-cols-2 gap-4 text-center">
                                ...
                                <div>
                                    <p class="text-2xl font-black text-red-500">{{ $riwayat->where('status_pembayaran', 'berhasil')->count() }}</p>
    ...
    @enderror
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-neutral-800">
                                    <div class="flex gap-4">
                                        ...
                                        <button type="button" class="text-red-500 hover:text-red-600 text-sm font-semibold transition-colors">
                                            Delete Account
                                        </button>
                                    </div>
                                    <button type="submit" 
...
<div class="flex flex-wrap items-center gap-2">
    ...
    {{-- 4. PENDING VERIFICATION (Sudah bayar, nunggu admin) --}}
