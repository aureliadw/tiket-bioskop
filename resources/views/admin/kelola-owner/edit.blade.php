...
<div class="min-h-screen bg-neutral-950 text-white px-6 py-10">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <h1 class="text-3xl font-bold text-red-500">Edit Owner</h1>
            ...
            <form action="{{ route('admin.owner.update', $owner->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" value="{{ $owner->nama_lengkap }}"
                ...
                <div class="mb-6">
                    ...
                    <select name="status_aktif"
                            class="w-full px-4 py-2 bg-neutral-800 border border-neutral-700 rounded-lg focus:outline-none focus:border-red-500 text-sm text-white">
                        <option value="1" {{ $owner->status_aktif ? 'selected' : '' }}>Aktif</option>
                        <option value="0" {{ !$owner->status_aktif ? 'selected' : '' }}>Nonaktif</option>
                    </select>
                </div>
