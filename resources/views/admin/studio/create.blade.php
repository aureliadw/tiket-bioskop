...
<div class="min-h-screen bg-neutral-950 text-white p-6">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold mb-2">Tambah Studio</h1>
                <p class="text-gray-400">Masukkan informasi studio baru</p>
            </div>
        ...
        {{-- Form --}}
        <form action="{{ route('admin.studio.store') }}" method="POST" class="space-y-6 bg-gradient-to-br from-neutral-900 to-neutral-950 border border-neutral-800 rounded-2xl p-8 shadow-xl">
            @csrf
            ...
            <div>
                ...
                <input type="number" name="total_kursi" value="{{ old('total_kursi') }}"
                       class="w-full px-4 py-3 bg-neutral-800 border border-neutral-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-600"
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4"
                          class="w-full px-4 py-3 bg-neutral-800 border border-neutral-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-600"
                          placeholder="Contoh: Studio dengan kursi recliner dan audio Dolby Atmos">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
