    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-4">
                <div class="text-center px-4 py-2 bg-neutral-900 rounded-lg border border-neutral-800">
                    <p class="text-2xl font-bold text-green-400">{{ $stats['pemesanan_hari_ini'] }}</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="group relative bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 overflow-hidden hover:scale-105 transition-all duration-300 cursor-pointer">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-blue-100 text-sm mb-1">Total Pemesanan</p>
                    <h3 class="text-3xl font-black">{{ $stats['total_pemesanan'] }}</h3>
                </div>
            </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-neutral-900 rounded-xl p-4 border border-neutral-800 hover:border-neutral-700 transition">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold">{{ $stats['total_film'] }}</p>
        ...
        <div class="bg-neutral-900 rounded-2xl border border-neutral-800 overflow-hidden">
            <div class="p-6 border-b border-neutral-800 flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-bold mb-1">Pemesanan Terbaru</h2>
                    <p class="text-sm text-gray-500">Activity terkini dari pelanggan</p>
                </div>
                <a href="{{ route('admin.pemesanan') }}" 
                   class="px-4 py-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg text-sm font-semibold transition flex items-center gap-2">
                    Lihat Semua
