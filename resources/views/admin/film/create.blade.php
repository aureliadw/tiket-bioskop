        ...
        <form action="{{ route('admin.film.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-5">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul') }}"
                       class="w-full px-4 py-2.5 bg-neutral-800 border border-neutral-700 rounded-lg 
            ...
            <div class="mb-5">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4"
                          class="w-full px-4 py-2.5 bg-neutral-800 border border-neutral-700 rounded-lg 
                                 focus:outline-none focus:border-red-500">{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div class="flex justify-end">
                <button type="submit"
                        class="px-8 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 
                               rounded-xl font-bold shadow-lg shadow-red-600/30 transition-all transform hover:scale-105">
                    Simpan Film
                </button>
            </div>
        </form>
