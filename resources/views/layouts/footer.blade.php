<footer class="mt-16 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
  {{-- Decorative elements --}}
  ...
  <div class="relative max-w-7xl mx-auto px-6 py-16">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
      ...
      <div class="lg:col-span-2">
        <span class="font-extrabold text-3xl tracking-wide flex items-center mb-4">
          <span class="text-red-600">H</span>
          <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-white-400 mx-0.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <p class="text-gray-400 mb-6 text-sm leading-relaxed max-w-xs">
          Your Happy Movie Experience - Nikmati pengalaman menonton terbaik dengan teknologi canggih dan kenyamanan maksimal.
        </p>
        
        {{-- Social Media Icons --}}
        <div class="flex gap-3">
          <a href="#" class="w-10 h-10 bg-gray-800 hover:bg-red-600 rounded-full flex items-center justify-center transition-all duration-300 group">
      ...
      {{-- Layanan --}}
      <div>
        <h3 class="font-bold text-white mb-4 text-lg">Layanan</h3>
        <ul class="space-y-3">
          <li>
            <a href="#" class="text-gray-400 hover:text-red-500 transition-colors duration-200 flex items-center group">
          ...
          <li>
            <a href="#panduan-booking" class="text-gray-400 hover:text-red-500 transition-colors duration-200 flex items-center group">
              <svg class="w-4 h-4 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
              </svg>
              Panduan Booking
      ...
      <div>
        ...
        <ul class="space-y-3">
          <li>
            <a href="{{ route('pelanggan.now-playing') }}" class="text-gray-400 hover:text-red-500 transition-colors duration-200 flex items-center group">
              <svg class="w-4 h-4 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
              </svg>
              Now Playing
          ...
          <li>
            <a href="{{ route('pelanggan.coming-soon') }}" class="text-gray-400 hover:text-red-500 transition-colors duration-200 flex items-center group">
              <svg class="w-4 h-4 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
              </svg>
              Coming Soon
      ...
      {{-- Kontak --}}
      <div>
        <h3 class="font-bold text-white mb-4 text-lg">Hubungi Kami</h3>
